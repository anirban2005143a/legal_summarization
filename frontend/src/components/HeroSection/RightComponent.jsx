...
const RightComponent = () => {
    return (
        <div className="md:w-[35%] md:min-w-[340px] md:max-w-[500px] ">
            <div className="relative h-full min-h-[500px] rounded-xl overflow-hidden shadow-xl border border-gray-200 bg-white">
                ...
                <div className=" p-3 pb-10 ">
                    ...
                    <div className=" pb-2 border-b border-gray-500">
                        ...
                        <h3 className="text-base font-bold text-gray-900">Sharma vs. State of Maharashtra</h3>
                        <p className="text-xs text-gray-500 mt-1">Right to Privacy - Constitutional Bench</p>
                    </div>

                    {/* Document text with highlights */}
                    <div className="user-select-none my-2 text-gray-700">
                        <div className="flex items-center space-x-2 text-[10px] text-gray-500 mb-2">
                            <FileText className="h-4 w-4 " />
                            <span className='  '>JUDGMENT EXCERPT</span>
                        </div>
                        ...
                        <div className="p-3 text-xs bg-[#f8f2e9] rounded border-l-3 border-[#7b1113] my-4">
                        ...
                        <div className=" pt-4 border-t border-dashed border-gray-400">
                            <h4 className="font-medium text-gray-900 mb-1 text-xs flex items-center">
                    ...
                    <div className="absolute h-10 bottom-1 left-4 right-4 flex justify-between items-center">
                        <div className="flex items-center space-x-4">
                            <button className="flex cursor-pointer items-center text-xs text-gray-500 hover:text-[#7b1113]">
