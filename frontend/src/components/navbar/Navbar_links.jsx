  ...
  return (
    <li className="relative group">
      ...
      >
        ...
        >
          {label}
          <span className={`absolute nav-menu-underline -bottom-1 left-0 ${isHovered ? "w-full" : "w-0"} h-[2px] bg-gradient-to-r from-red-800 to-red-700 group-hover:w-full transition-all duration-300`}></span>
        </span>
        {hasDropdown && (
          <svg
